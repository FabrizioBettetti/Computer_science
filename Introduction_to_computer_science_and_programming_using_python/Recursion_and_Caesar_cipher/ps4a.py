# Imports the Node object used to construct trees
...
def is_heap(tree, compare_func):
    ...
    if tree.get_left_child() == None and tree.get_right_child() == None:
        return True
    if is_heap(tree.get_left_child(), compare_func) and is_heap(tree.get_right_child(), compare_func) and \
       (tree.get_left_child() == None or compare_func(tree.get_left_child().get_value(), tree.get_value())) and \
       (tree.get_right_child() == None or compare_func(tree.get_right_child().get_value(), tree.get_value())):
       return True
    return False
