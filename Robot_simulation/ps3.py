...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        self.dirt_amount[(m, n)] = max(0, self.get_dirt_amount(m, n) - capacity)
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        self.set_robot_position(room.get_random_position())
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for _ in range(num_trials):
        ...
        current_coverage = room.get_num_cleaned_tiles() / num_tiles
        ...
        trials_time_steps.append(time_steps)
...
#
#    Answer.
#    Configuration with faulty robots is always slower than configuration with standard robots (but the difference of time steps
#    reduces increasing the number of robots).
#    Time steps of each type of robot reduces increasing the number of robots
#
#
...
#
#    Answer.
#    Configuration with faulty robots is always slower than configuration with standard robots.
#    The first decreasing part of the plot is due to the fact that room width is lesser than room height (it doesn't matter which
#    dimension is the greatest).
#    A dominant dimension translates in bigger time steps because robots can't easily reach distant parts of the room
...
def run_simulation_with_visualization(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
                                      robot_type, is_furnished, delay=0.2):
    trials_time_steps = []
...
# run_simulation_with_visualization(3, 1.0, 1, 20, 20, 3, 0.5, 1, StandardRobot, False)
